...
$(document).ready(function() {
    (function( $ ) {
        $.widget('adzlocal.stickyTableHeader', {
            // Set up the widget
            _create: function() {
                var tableHeader = this.element.find('thead');
                var stickyHeaderTop = tableHeader.offset().top;
                
                this._on($(window), {
                    scroll: function () {
                        if ($(window).scrollTop() > stickyHeaderTop) {
                            tableHeader.find('th, td').each(function(i, e) {
                                console.log($(e).width());
                                $(e).css({
                                    width: $(e).width() + 1,
...
//                        'left': newLeft,
//                        'display': 'block',
//                        'width': $this.closest('table').width
//                    });
