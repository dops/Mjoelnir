...
class Mjoelnir_Db_Config_Abstract
{
    ...
    /**
     * <p>Tabel name constants.</p>
     * <p>ATTENTION: Only basic tables are named here further tables have to be named in the extended config.</p>
     * <p>ATTENTION: The placeholder under the given constants should be also placed in the extended config. It is needed by the model builder, to add further tables
     * automatically.</p>
     */
