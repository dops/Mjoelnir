 ...
 */
class Mjoelnir_Form_Element_Number extends Mjoelnir_Form_Element_Abstract
{
     ...
     * @var integer
     */
    protected $iMin = array();

    /**
     * The maximum value.
     * @var integer
     */
    protected $iMax = array();

    /**
     * The step to increase and decrease the number.
     * @var integer
     */
    protected $iStep = array();
     ...
     * @param   array   $iMin           The min value.
     * @param   array   $iMax           The max value.
     * @param   array   $iStep          The step to increase and decrease the number.
     ...
     */
    public function __construct($sName, $mValue, $iMin, $iMax, $iStep, $aOptions = array(), $sTemplateDir = null, $sPrefix = '', $sSuffix = '') {
        $this->_sName        = $sName;
        $this->_mValue       = $mValue;
        $this->iMin          = $iMin;
        $this->iMax          = $iMax;
    ...
    protected function _render() {
        ...
        $this->_oView->assign('iMin', $this->iMin);
        $this->_oView->assign('iMax', $this->iMax);
        $this->_oView->assign('iStep', $this->iStep);
